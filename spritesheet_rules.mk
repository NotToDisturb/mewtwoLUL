...
$(OBJEVENTGFXDIR)/people/lul_child_1.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
    
$(OBJEVENTGFXDIR)/people/lul_child_2.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/lul_mother.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/lul_father.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/pokemon/lul_mewtwo.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 4 -mheight 4
